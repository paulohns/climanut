<!DOCTYPE html>
		...
		<article class="pesquisar" style="margin-top:-20px;"><br>
			<span id="corTitulo"> Pesquisar Manutenção Anvisa </span>
			...
			<div id="formPesquisaFiltro" style="display:none"><br><br>
				...
				<input id="botaoPesquisarManutencaoAnvisa" name="acao" class="botao" type="submit" value="Pesquisar">
