...
<title>Climanut - Atividade Anvisa</title>
...
<body>
	<div id="container">
		...
		<section id="baseCadPesq" style="height:1000px;"><br>
			...
			<span id="corTitulo">&there4; Atividade Anvisa</span>&nbsp;&nbsp;
			<jsp:include page="../botoes/botaoVoltar.jsp"></jsp:include>
			</div>
			<jsp:include page="atividadeAnvisaCad.jsp"></jsp:include>
			<jsp:include page="atividadeAnvisaPesq.jsp"></jsp:include>
		</section>		
		<footer>Teste</footer>
	</div>
